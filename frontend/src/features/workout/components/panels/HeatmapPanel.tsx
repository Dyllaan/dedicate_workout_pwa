...
import { useWorkoutTemplateHeatmap } from "@/features/heatmap/hooks/useMuscleHeatmap";
...
import { MUSCLE_GROUPS, MUSCLE_LABELS, intensityColor } from "@/features/heatmap/config/muscleMetadata";
import { PillCard } from "@/components/layout/card/PillCard";
import { DashCardRow } from "@/components/layout/card/DashCardRow";

const MuscleBody = lazy(() => import("@/features/heatmap/components/MuscleBody"));
