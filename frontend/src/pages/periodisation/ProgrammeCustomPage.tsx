...
import type { BlockType, ProgressionStrategy, CreateProgrammeRequest, BlockDraft } from '@/features/periodisation/types/Periodisation';
import { BLOCK_TYPE_CONFIG, BLOCK_TYPE_FALLBACK, STRATEGY_LABELS, BLOCK_DEFAULTS } from '@/features/periodisation/utils/periodisationConfig';
