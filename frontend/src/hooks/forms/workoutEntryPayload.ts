import type { WorkoutEntryExerciseDraft } from "./workoutEntryFormTypes";
import type { ReadinessCheckInRequest } from "@/types/Insights";
import { toCreatePayloadFields } from "@/types/exerciseIdentity";

export function buildWorkoutEntryPayload(
  templateId: string,
