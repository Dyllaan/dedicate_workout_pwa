import type {ExerciseConfig, WorkoutTemplate} from "@/types/Workout";
import Panel from "@/components/layout/Panel";
import { useState } from "react";
import {Dumbbell, Save} from "lucide-react";
import { DashCardRow } from "@/components/layout/card/DashCardRow";
import {formatExerciseLabel} from "@/components/insights/insightsUtils.ts";
import buildExerciseHistoryHref from "@/utils/buildExerciseHistoryHref.ts";
import {Button, Input} from "@/components/ui";
import {useWorkoutSettings} from "@/hooks/workout/useWorkoutSettings.ts";
